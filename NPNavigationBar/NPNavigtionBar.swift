...
public class NPNavigtionBar: UIView {
    ...
    // MARK: 初始化
    class func npNavigtionBar() -> NPNavigtionBar{
        let navigationBar = NPNavigtionBar(frame: CGRect(x: 0, y: 0, width: kNPNavigationScreenWidth, height: kNPNavigationBarHeight))
